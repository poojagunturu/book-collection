...
campus_oracle_db =
  '(DESCRIPTION =\
    (ADDRESS = (PROTOCOL = TCP)(HOST = ora-scsp.srv.mst.edu)(PORT = 1521))\
    (CONNECT_DATA =\
      (SERVER = DEDICATED)\
      (SID = scsp)\
    )\
...
module.exports = {
  user          : process.env.NODE_ORACLEDB_USER || 'ADD YOUR USERNAME HERE',
  password      : process.env.NODE_ORACLEDB_PASSWORD || 'ADD YOUR PASSWORD HERE',

  // For information on connection strings see:
  // https://oracle.github.io/node-oracledb/doc/api.html#connectionstrings
  connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || campus_oracle_db,
